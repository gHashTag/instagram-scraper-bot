...
export const competitors = pgTable(
  ...
  (table) => [
    ...
    unique("competitors_project_id_username_key").on(
      table.projectId,
      table.username
    ),
  ]
...
export const hashtags = pgTable(
  ...
  (table) => [
    ...
    unique("hashtags_project_id_tag_name_key").on(
      table.projectId,
      table.tagName
    ),
  ]
...
export const parsingRuns = pgTable(
  "parsing_runs",
  {
    id: serial().primaryKey().notNull(),
...
export const users = pgTable(
  "users",
  {
    ...
    subscriptionLevel: varchar("subscription_level", { length: 50 })
      .default("free")
      .notNull(),
