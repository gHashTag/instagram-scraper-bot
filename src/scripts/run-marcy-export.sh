...
# Скрипт для экспорта данных по хэштегам для проекта Марси
...
bun run src/scripts/export-hashtag-reels-to-excel.ts 5 50000 "exports/marcy_aesthetic_medicine_$(date +%Y-%m-%d).xlsx"
