...
(skipTests ? describe.skip : describe)(
  ...
  () => {
    ...
    it("should measure vector search performance", async () => {
      ...
      console.log(
        `Vector search performance: ${duration.toFixed(2)} ms for 10 searches`
      );
      console.log(
        `Average search time: ${(duration / 10).toFixed(2)} ms per search`
      );
    ...
    it("should measure vector search performance using function", async () => {
      ...
      console.log(
        `Vector search performance using function: ${duration.toFixed(2)} ms for 10 searches`
      );
      console.log(
        `Average search time using function: ${(duration / 10).toFixed(2)} ms per search`
      );
    ...
    it("should measure vector search performance using service", async () => {
      ...
      for (let i = 0; i < 10; i++) {
        ...
        // Выполняем поиск похожих расшифровок
        const results = await embeddingsService.searchSimilarTranscripts(
          query,
          5
        );
      ...
      console.log(
        `Vector search performance using service: ${duration.toFixed(2)} ms for 10 searches`
      );
      console.log(
        `Average search time using service: ${(duration / 10).toFixed(2)} ms per search`
      );
