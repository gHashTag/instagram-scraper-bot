...
export function createMockStorageAdapter(): MockedStorageAdapterType {
  return {
    ...
    saveUser: jest.fn().mockImplementation(() => Promise.resolve(null)),
    findUserByTelegramIdOrCreate: jest
      .fn()
      .mockImplementation(() => Promise.resolve(null)),
    ...
    deleteProject: jest.fn().mockImplementation(() => Promise.resolve(false)),
    getCompetitorAccounts: jest
      .fn()
      .mockImplementation(() => Promise.resolve([])),
    getCompetitorsByProjectId: jest
      .fn()
      .mockImplementation(() => Promise.resolve([])),
    addCompetitorAccount: jest
      .fn()
      .mockImplementation(() => Promise.resolve(null)),
    deleteCompetitorAccount: jest
      .fn()
      .mockImplementation(() => Promise.resolve(false)),
    getTrackingHashtags: jest
      .fn()
      .mockImplementation(() => Promise.resolve([])),
    getHashtagsByProjectId: jest
      .fn()
      .mockImplementation(() => Promise.resolve([])),
    ...
    getReelsByCompetitorId: jest
      .fn()
      .mockImplementation(() => Promise.resolve([])),
    getReelsByProjectId: jest
      .fn()
      .mockImplementation(() => Promise.resolve([])),
    ...
    getParsingLogsByProjectId: jest
      .fn()
      .mockImplementation(() => Promise.resolve([])),
    getNotificationSettings: jest
      .fn()
      .mockImplementation(() => Promise.resolve(null)),
    saveNotificationSettings: jest
      .fn()
      .mockImplementation(() => Promise.resolve(null)),
    updateNotificationSettings: jest
      .fn()
      .mockImplementation(() => Promise.resolve(null)),
    getUserById: jest.fn().mockImplementation(() => Promise.resolve(null)),
    getNewReels: jest.fn().mockImplementation(() => Promise.resolve([])),
    executeQuery: jest.fn().mockImplementation(() => Promise.resolve([])),
  };
}
