...
export class ReelsCollectionService {
  ...
  async createCollection(
    ...
    try {
      if (!this.storage.createReelsCollection) {
        throw new Error(
          "Метод createReelsCollection не реализован в адаптере хранилища"
        );
      }
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при создании коллекции:",
        error
      );
      throw error;
    }
   ...
   */
  async getCollectionsByProjectId(
    projectId: number
  ): Promise<ReelsCollection[]> {
    try {
      if (!this.storage.getReelsCollectionsByProjectId) {
        throw new Error(
          "Метод getReelsCollectionsByProjectId не реализован в адаптере хранилища"
        );
      }
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при получении коллекций:",
        error
      );
      return [];
    }
  ...
  async getCollectionById(
    ...
    try {
      if (!this.storage.getReelsCollectionById) {
        throw new Error(
          "Метод getReelsCollectionById не реализован в адаптере хранилища"
        );
      }
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при получении коллекции:",
        error
      );
      return null;
    }
  ...
  async updateCollection(
    ...
    try {
      if (!this.storage.updateReelsCollection) {
        throw new Error(
          "Метод updateReelsCollection не реализован в адаптере хранилища"
        );
      }
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при обновлении коллекции:",
        error
      );
      return null;
    }
  ...
  async deleteCollection(collectionId: number): Promise<boolean> {
    try {
      if (!this.storage.deleteReelsCollection) {
        throw new Error(
          "Метод deleteReelsCollection не реализован в адаптере хранилища"
        );
      }
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при удалении коллекции:",
        error
      );
      return false;
    }
  ...
  async processCollection(
    ...
    try {
      if (!this.storage.processReelsCollection) {
        throw new Error(
          "Метод processReelsCollection не реализован в адаптере хранилища"
        );
      }
      ...
      const updatedCollection = await this.storage.updateReelsCollection(
        collectionId,
        {
          is_processed: true,
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при обработке коллекции:",
        error
      );
   ...
   */
  private async getReelsForCollection(
    ...
    try {
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при получении Reels для коллекции:",
        error
      );
      return [];
    }
  ...
  private createContentForReels(
    ...
    try {
      ...
      const processedReels = reels.map((reel) =>
        this.marketingService.calculateMarketingData(reel)
      );
      ...
      logger.error(
        "[ReelsCollectionService] Ошибка при создании контента для Reels:",
        error
      );
      throw error;
    }
  ...
  private createTextContent(reels: ReelContent[]): string {
    ...
    reels.forEach((reel, index) => {
      ...
      if (
        reel.engagement_rate_video !== undefined &&
      ...
      if (
        reel.engagement_rate_all !== undefined &&
      ...
      if (
        reel.view_to_like_ratio !== undefined &&
  ...
  private createCsvContent(reels: ReelContent[]): string {
    ...
    const rows = reels.map((reel) => [
      ...
      reel.engagement_rate_video !== undefined
        ? reel.engagement_rate_video.toFixed(2)
        : "",
      reel.engagement_rate_all !== undefined
        ? reel.engagement_rate_all.toFixed(2)
        : "",
      reel.view_to_like_ratio !== undefined
        ? reel.view_to_like_ratio.toFixed(2)
        : "",
      reel.comments_to_likes_ratio !== undefined
        ? reel.comments_to_likes_ratio.toFixed(2)
        : "",
